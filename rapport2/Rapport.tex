...
We didn't have enough time to run further experiments using these different data sets. Our future work will consist in running more experiments, using more hidden layers for instance, in order to finally have better results than i-vectors. We are confident that we will soon be able to obtain better results than i-vectors.
