...
\item{Optimizer}: \todo{compléter, Descente de gradient, Adam...}
\item{Dropout}: \todo{keep proba}
\end{itemize}


\subsection{Graphical representation}

In order to clearly represent our results, we used Detection Error Tradeoff (DET) graph. A DET graph plots the false rejection rate vs. the false acceptance rate. \todo{Compléter}

\subsection{Results}

We ran many experiments and therefore cannot present them all. We will only present the most interesting.

\subsubsection{Experiment 0}

The table below presents the configration we ised for this experiment:
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=8cm]{../scores/det0.pdf}
\end{figure}

\begin{figure}[!h]
    \centering
    \includegraphics[width=8cm]{../scores/det1.pdf}
\end{figure}


\begin{figure}[!h]
    \centering
    \includegraphics[width=8cm]{../scores/det2.pdf}
\end{figure}


\begin{figure}[!h]
    \centering
    \includegraphics[width=8cm]{../scores/det2bis.pdf}
\end{figure}


\begin{figure}[!h]
    \centering
    \includegraphics[width=8cm]{../scores/det3.pdf}
\end{figure}


\begin{figure}[!h]
    \centering
    \includegraphics[width=8cm]{../scores/det4.pdf}
\end{figure}


\begin{figure}[!h]
    \centering
    \includegraphics[width=8cm]{../scores/det5.pdf}
\end{figure}


\begin{figure}[!h]
    \centering
    \includegraphics[width=8cm]{../scores/det7.pdf}
\end{figure}
