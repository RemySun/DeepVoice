...
\begin{tikzpicture}[shorten >=1pt,->,draw=black!50, node distance=\layersep]
    ...
    % Annotate the layers
    \node[annot,above of=H2-1] (hl2) {New representation};
    \node[annot,above of=H4-1] {Output layer: Second supervector};
    \node[annot,above of=I-1] {Input layer: First supervector};
