...
\newcommand\blfootnote[1]{%
 http://stackoverflow.com/questions/3210205/how-to-get-rid-of-navigation-bars-in-beamer \begingroup
...
\begin{tikzpicture}[scale=0.8, shorten >=1pt,->,draw=black!50, node distance=\layersep]
    ...
    \visible<2>{
        \path [draw, thick, fill=yellow!20] (-1,0.5) rectangle (4.5,-6);
    }
    \visible<3->{
        \path [draw, thick] (-1,0.5) rectangle (4.5,-6);
    }
    \visible<3>{
        \path [draw, thick,  fill=yellow!20] (2.7,0.3) rectangle (8.2,-5.8);
    }
    \visible<4->{
        \path [draw, thick] (2.7,0.3) rectangle (8.2,-5.8);
    }
    ...
    \visible<2->{
    \node[annot,above of=H1-1, node distance=2.1cm] (xl) {encoder};
    }
    \visible<3->{
    \node[annot,above of=H3-1, node distance=2.1cm] (xo) {decoder};
    }
