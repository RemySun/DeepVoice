...
train_step = tf.train.AdamOptimizer(0.001).minimize(meansq)
...
for i in range(n_rounds):
    ...
    save_path = saver.save(sess, "exp_" + str(n_input) + "_" + str(n_layer1) + "_" + str(n_layer2) + "_" + str(n_hidden) + "_model.ckpt")
