...
\todo[inline]{Ajouter les références}
...
%We want to split this vector into two components, $s$ and $v$ such as $M = s + c$ with :
%\begin{itemize}
%\item $s$ is the speaker dependant supervector
%\item $c$ is the channel dependant supervector
%\end{itemize}
...
deep and encodes the input of size 9311 into a latent representation of size 40.
...
representation back into a 9311 dimensional supervector by successively
